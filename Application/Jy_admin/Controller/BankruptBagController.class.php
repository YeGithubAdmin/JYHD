...
class BankruptBagController extends ComController {
    public function index(){
        $page           = $this->page;              //页码
        $num            = $this->num;               //条数
        $where = ' ShowType = 6 and IsDel = 1';
    ...
    public function  add(){
        ...
        if(IS_POST){
            ...
            $ShowType                    =           I('param.ShowType',6,'intval');                    //展示方式
            $Name                        =           I('param.Name','','trim');                         //物品名
            $CurrencyType                =           I('param.CurrencyType',1,'intval');                //货币类型 1-人民币 2-金币 3-砖石
            ...
            $GetNum                      =           I('param.GetNum',1,'intval');                      //获得数量
            $GiveInfo                    =           I('param.GiveInfo','','trim');                     //赠送
            $IsGroom                     =           I('param.IsGroom',1,'intval');                     //是否推荐 1-否 2-是
            ...
            $ExchangeNum                 =           I('param.ExchangeNum',1,'intval');                 //限兑换数量
