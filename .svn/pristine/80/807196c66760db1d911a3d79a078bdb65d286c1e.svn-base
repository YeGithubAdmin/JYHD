...
class GoodsAllController extends ComController {
    public function index(){
        ...
        $catVipInfo = M('jy_goods_all')
            ...
            ->field('Id,Code,Name,CurrencyType,GetNum,Type,CateGory
                    ,LimitLevel,LimitVip,CateGory,IssueNum,IssueType,Status,ShowType
                    ,DateTime,UpTime')
            ->order('Sort asc')
            ->select();
    ...
    public function edit(){
        ...
        $catGoodsAllInfo = M('jy_goods_all')
                            ...
                            ,LimitShop,LimitShopNum,ExchangeType,ShowType,ExchangeNum,Describe,Proportion,Push,Broadcast,Rmark,GetNum,LimitLevel,LimitVip')
                            ->find();
