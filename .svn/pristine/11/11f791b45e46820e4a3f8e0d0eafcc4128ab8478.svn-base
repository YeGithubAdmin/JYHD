...
class SevenDaysSignTwoController extends ComController {
    ...
    public function  add(){
        ...
        if(IS_POST){
            ...
            if($addSevenDaysSign){
                $obj->showmessage('添加成功','/jy_admin/SevenDaysSignTwo/index');
            }else{
    ...
    public function edit(){
        ...
        if(IS_POST){
            ...
            if($upSevenDaysSign !== false){
                $obj->showmessage('修改成功','/jy_admin/SevenDaysSignTwo/index');
            }else{
